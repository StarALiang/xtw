SET NAMES UTF8;
DROP DATABASE IF EXISTS xtw;
CREATE DATABASE xtw CHARSET=UTF8;
USE xtw;


/**笔记本电脑型号家族**/
CREATE TABLE xtw_laptop_family(
  fid INT PRIMARY KEY AUTO_INCREMENT,
  fname VARCHAR(32)
);

/**笔记本电脑**/
CREATE TABLE xtw_laptop(
...
/**收货地址信息**/
CREATE TABLE xtw_receiver_address(
...
/**购物车条目**/
CREATE TABLE xtw_shoppingcart_item(
...
/****首页轮播广告商品****/
CREATE TABLE xtw_index_carousel(
...
/****首页商品****/
CREATE TABLE xtw_index_product(
  pid INT PRIMARY KEY AUTO_INCREMENT,
  title VARCHAR(64),
  details VARCHAR(128),
  pic VARCHAR(128),
...
/*******************/
/**笔记本电脑型号家族**/
INSERT INTO xtw_laptop_family VALUES
...
/**笔记本电脑图片**/
INSERT INTO xtw_laptop_pic VALUES
...
/****首页轮播广告商品****/
INSERT INTO xtw_index_carousel VALUES
...
/****首页商品****/
INSERT INTO xtw_index_product VALUES
